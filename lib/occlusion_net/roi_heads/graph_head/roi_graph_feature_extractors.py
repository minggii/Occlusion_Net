...
class graphRCNNFeatureExtractor(nn.Module):
    def __init__(self, cfg):
        ...
        self.off_diag = np.ones([cfg.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES, cfg.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES]) \
                        - np.eye(cfg.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES)
